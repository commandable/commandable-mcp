<template>
  <UContainer class="py-10 space-y-6">
    <div class="flex items-center justify-between gap-4">
      ...
      <UButton icon="i-lucide-plus" @click="showAddModal = true">
        Add Integration
      </UButton>
    </div>
    ...
    <div v-else-if="!integrations?.length" class="py-16 text-center space-y-4">
      <div class="text-muted text-sm">
        No integrations yet.
      </div>
      <UButton icon="i-lucide-plus" variant="soft" @click="showAddModal = true">
    ...
    <div v-else class="space-y-2">
      ...
      >
        ...
        <UIcon name="i-lucide-chevron-right" class="text-muted opacity-0 group-hover:opacity-100 transition-opacity shrink-0" />
      </NuxtLink>
    </div>
