...
// LIVE Google Docs write tests using Nango
// Required env vars:
...
describe('google-docs write handlers (live)', () => {
  ...
  beforeAll(async () => {
    const { NUXT_PUBLIC_NANGO_API_BASE_URL, NUXT_NANGO_SECRET_KEY, GDOCS_TEST_CONNECTION_ID, GDOCS_TEST_DOCUMENT_ID } = env
