...
// LIVE Google Calendar write/admin tests using Nango
// Required env vars:
...
describe('google-calendar write & admin handlers (live)', () => {
  ...
  beforeAll(async () => {
    const { NUXT_PUBLIC_NANGO_API_BASE_URL, NUXT_NANGO_SECRET_KEY, GCAL_TEST_CONNECTION_ID, GCAL_TEST_CALENDAR_ID } = env
